# -*- coding: utf-8 -*-
"""
INTEGRA - Install Edit Employee Screen
=======================================
سكريبت تثبيت شاشة تعديل الموظف تلقائياً
شغّل هذا الملف مرة واحدة وبعدين امسحه
"""
...
SCREENS_DIR = os.path.join(BASE, "modules", "mostahaqat", "screens")
EDIT_DIR = os.path.join(SCREENS_DIR, "edit_employee")
MW_FILE = os.path.join(BASE, "modules", "mostahaqat", "window", "mostahaqat_window.py")

print("=" * 60)
print("   INTEGRA - تثبيت شاشة تعديل الموظف")
print("=" * 60)
print()

# ══════════════════════════════════════════════════════════
# الخطوة 1: إنشاء مجلد edit_employee
# ══════════════════════════════════════════════════════════

print("[1/4] إنشاء مجلد edit_employee...")

os.makedirs(EDIT_DIR, exist_ok=True)
print("  ✅ تم إنشاء المجلد")

# ══════════════════════════════════════════════════════════
# الخطوة 2: إنشاء ملف edit_employee_screen.py
# ══════════════════════════════════════════════════════════

print("[2/4] إنشاء ملف edit_employee_screen.py...")

edit_screen_code = '''# -*- coding: utf-8 -*-
"""
Edit Employee Screen
====================
\\u0634\\u0627\\u0634\\u0629 \\u062a\\u0639\\u062f\\u064a\\u0644 \\u0628\\u064a\\u0627\\u0646\\u0627\\u062a \\u0627\\u0644\\u0645\\u0648\\u0638\\u0641
"""
...
class EditEmployeeScreen(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._back_btn = QPushButton("\\u2192 \\u0631\\u062c\\u0648\\u0639")
        ...
        self._title_label = QLabel("\\U0001f4dd \\u062a\\u0639\\u062f\\u064a\\u0644 \\u0628\\u064a\\u0627\\u0646\\u0627\\u062a \\u0627\\u0644\\u0645\\u0648\\u0638\\u0641")
        ...
        # Basic Info Card
        basic_card = self._create_card("\\U0001f4cb \\u0627\\u0644\\u0628\\u064a\\u0627\\u0646\\u0627\\u062a \\u0627\\u0644\\u0623\\u0633\\u0627\\u0633\\u064a\\u0629")
        basic_grid = QGridLayout()
        basic_grid.setSpacing(15)
        basic_grid.setColumnStretch(1, 1)
        basic_grid.setColumnStretch(3, 1)
        
        self._inputs['employee_code'] = self._add_input(basic_grid, "\\u0643\\u0648\\u062f \\u0627\\u0644\\u0645\\u0648\\u0638\\u0641", 0, 0, readonly=True)
        self._inputs['status_id'] = self._add_combo(basic_grid, "\\u0627\\u0644\\u062d\\u0627\\u0644\\u0629", 0, 1)
        self._inputs['name_ar'] = self._add_input(basic_grid, "\\u0627\\u0644\\u0627\\u0633\\u0645 \\u0628\\u0627\\u0644\\u0639\\u0631\\u0628\\u064a", 1, 0)
        self._inputs['name_en'] = self._add_input(basic_grid, "\\u0627\\u0644\\u0627\\u0633\\u0645 \\u0628\\u0627\\u0644\\u0625\\u0646\\u062c\\u0644\\u064a\\u0632\\u064a", 1, 1)
        self._inputs['national_id'] = self._add_input(basic_grid, "\\u0631\\u0642\\u0645 \\u0627\\u0644\\u0647\\u0648\\u064a\\u0629", 2, 0)
        self._inputs['nationality_id'] = self._add_combo(basic_grid, "\\u0627\\u0644\\u062c\\u0646\\u0633\\u064a\\u0629", 2, 1)
        self._inputs['hire_date'] = self._add_date(basic_grid, "\\u062a\\u0627\\u0631\\u064a\\u062e \\u0627\\u0644\\u062a\\u0639\\u064a\\u064a\\u0646", 3, 0)
        
        basic_card.layout().addLayout(basic_grid)
        scroll_layout.addWidget(basic_card)
        
        # Job Info Card
        job_card = self._create_card("\\U0001f4bc \\u0627\\u0644\\u0628\\u064a\\u0627\\u0646\\u0627\\u062a \\u0627\\u0644\\u0648\\u0638\\u064a\\u0641\\u064a\\u0629")
        job_grid = QGridLayout()
        job_grid.setSpacing(15)
        job_grid.setColumnStretch(1, 1)
        job_grid.setColumnStretch(3, 1)
        
        self._inputs['company_id'] = self._add_combo(job_grid, "\\u0627\\u0644\\u0634\\u0631\\u0643\\u0629", 0, 0)
        self._inputs['department_id'] = self._add_combo(job_grid, "\\u0627\\u0644\\u0642\\u0633\\u0645", 0, 1)
        self._inputs['job_title_id'] = self._add_combo(job_grid, "\\u0627\\u0644\\u0648\\u0638\\u064a\\u0641\\u0629", 1, 0)
        
        job_card.layout().addLayout(job_grid)
        scroll_layout.addWidget(job_card)
        
        # Bank Info Card
        bank_card = self._create_card("\\U0001f3e6 \\u0627\\u0644\\u0628\\u064a\\u0627\\u0646\\u0627\\u062a \\u0627\\u0644\\u0628\\u0646\\u0643\\u064a\\u0629")
        bank_grid = QGridLayout()
        bank_grid.setSpacing(15)
        bank_grid.setColumnStretch(1, 1)
        bank_grid.setColumnStretch(3, 1)
        
        self._inputs['bank_id'] = self._add_combo(bank_grid, "\\u0627\\u0644\\u0628\\u0646\\u0643", 0, 0)
        ...
        self._cancel_btn = QPushButton("\\u274c \\u0625\\u0644\\u063a\\u0627\\u0621")
        ...
        self._save_btn = QPushButton("\\u2705 \\u062d\\u0641\\u0638 \\u0627\\u0644\\u062a\\u0639\\u062f\\u064a\\u0644\\u0627\\u062a")
    ...
    def _add_input(self, grid, label, row, col, readonly=False):
        ...
        inp.setPlaceholderText(f"\\u0623\\u062f\\u062e\\u0644 {label}")
    ...
    def set_employee(self, data):
        ...
        self._title_label.setText(f"\\U0001f4dd \\u062a\\u0639\\u062f\\u064a\\u0644 \\u0628\\u064a\\u0627\\u0646\\u0627\\u062a: {name}")
    ...
    def _on_save(self):
        ...
        if not name_ar and not name_en:
            QMessageBox.warning(self, "\\u062a\\u0646\\u0628\\u064a\\u0647", "\\u064a\\u062c\\u0628 \\u0625\\u062f\\u062e\\u0627\\u0644 \\u0627\\u0633\\u0645 \\u0627\\u0644\\u0645\\u0648\\u0638\\u0641!")
            return
        
        employee_id = self._employee.get('id')
        if not employee_id:
            QMessageBox.critical(self, "\\u062e\\u0637\\u0623", "\\u0644\\u0645 \\u064a\\u062a\\u0645 \\u062a\\u062d\\u062f\\u064a\\u062f \\u0627\\u0644\\u0645\\u0648\\u0638\\u0641!")
            return
        ...
        if success:
            QMessageBox.information(self, "\\u062a\\u0645 \\u2705", "\\u062a\\u0645 \\u062d\\u0641\\u0638 \\u0627\\u0644\\u062a\\u0639\\u062f\\u064a\\u0644\\u0627\\u062a \\u0628\\u0646\\u062c\\u0627\\u062d!")
            ...
            QMessageBox.critical(self, "\\u062e\\u0637\\u0623 \\u274c", "\\u0641\\u0634\\u0644 \\u062d\\u0641\\u0638 \\u0627\\u0644\\u062a\\u0639\\u062f\\u064a\\u0644\\u0627\\u062a!")
...
with open(os.path.join(EDIT_DIR, "edit_employee_screen.py"), "w", encoding="utf-8") as f:
    f.write(edit_screen_code)
print("  ✅ تم إنشاء edit_employee_screen.py")

# ══════════════════════════════════════════════════════════
# إنشاء __init__.py لمجلد edit_employee
# ══════════════════════════════════════════════════════════

init_code = '''"""Edit Employee Screen."""

from .edit_employee_screen import EditEmployeeScreen

__all__ = ['EditEmployeeScreen']
'''

with open(os.path.join(EDIT_DIR, "__init__.py"), "w", encoding="utf-8") as f:
    f.write(init_code)
print("  ✅ تم إنشاء __init__.py")

# ══════════════════════════════════════════════════════════
# تحديث screens/__init__.py
# ══════════════════════════════════════════════════════════
...
from .employees_list import EmployeesListScreen
from .employee_profile import EmployeeProfileScreen
from .edit_employee import EditEmployeeScreen
...
with open(os.path.join(SCREENS_DIR, "__init__.py"), "w", encoding="utf-8") as f:
    f.write(screens_init)
print("  ✅ تم تحديث screens/__init__.py")

# ══════════════════════════════════════════════════════════
# الخطوة 3: تعديل mostahaqat_window.py
# ══════════════════════════════════════════════════════════

print("[3/4] تعديل mostahaqat_window.py...")

if not os.path.exists(MW_FILE):
    print(f"  ❌ الملف غير موجود: {MW_FILE}")
    sys.exit(1)
...
old_import = "from modules.mostahaqat.screens import EmployeesListScreen, EmployeeProfileScreen"
new_import = "from modules.mostahaqat.screens import EmployeesListScreen, EmployeeProfileScreen, EditEmployeeScreen"

if old_import in content and "EditEmployeeScreen" not in content:
    content = content.replace(old_import, new_import)
    changes_made += 1
    print("  ✅ تعديل 1: إضافة import")
elif "EditEmployeeScreen" in content:
    print("  ⏭️ تعديل 1: موجود مسبقاً")
else:
    print("  ⚠️ تعديل 1: لم يتم العثور على السطر المطلوب")

# التعديل 2: إضافة المتغير
old_var = "self._employee_profile_screen = None"
new_var = "self._employee_profile_screen = None\n        self._edit_employee_screen = None"

if old_var in content and "_edit_employee_screen" not in content:
    content = content.replace(old_var, new_var, 1)
    changes_made += 1
    print("  ✅ تعديل 2: إضافة المتغير")
elif "_edit_employee_screen" in content:
    print("  ⏭️ تعديل 2: موجود مسبقاً")

# التعديل 3: إضافة الشاشة في الـ stack
# نبحث عن آخر addWidget للبروفايل ونضيف بعده
search_text = "self._stack.addWidget(self._employee_profile_screen)"
add_text = """self._stack.addWidget(self._employee_profile_screen)
...
if search_text in content and "_on_employee_saved" not in content:
    content = content.replace(search_text, add_text, 1)
    changes_made += 1
    print("  ✅ تعديل 3: إضافة الشاشة في الـ stack")
elif "_on_employee_saved" in content:
    print("  ⏭️ تعديل 3: موجود مسبقاً")

# التعديل 4: استبدال دالة _edit_employee_data
# نبحث عن الدالة الحالية (قيد التطوير) ونستبدلها
old_edit_func = '''    def _edit_employee_data(self, emp: dict):
        show_info(self, "\u062a\u0639\u062f\u064a\u0644", f"\u062a\u0639\u062f\u064a\u0644 {emp.get(\'name_ar\', \'\')} - \u0642\u064a\u062f \u0627\u0644\u062a\u0637\u0648\u064a\u0631")'''

new_edit_func = '''    def _edit_employee_data(self, emp: dict):
        """فتح شاشة تعديل بيانات الموظف."""
        self._edit_employee_screen.set_employee(emp)
        self._stack.setCurrentIndex(3)
        self.statusBar().showMessage(f"تعديل: {emp.get('name_ar', '')}")'''

if old_edit_func in content:
    content = content.replace(old_edit_func, new_edit_func)
    changes_made += 1
    print("  ✅ تعديل 4: استبدال _edit_employee_data")
else:
    # محاولة بديلة - البحث بدون Unicode escapes
    import re
    pattern = r'    def _edit_employee_data\(self, emp: dict\):.*?show_info\(self.*?\)'
    match = re.search(pattern, content, re.DOTALL)
    if match and "_stack.setCurrentIndex(3)" not in content.split("_edit_employee_data")[1][:200]:
        content = content.replace(match.group(), new_edit_func)
        changes_made += 1
        print("  ✅ تعديل 4: استبدال _edit_employee_data (بديل)")
    elif "_stack.setCurrentIndex(3)" in str(content.split("_edit_employee_data")[1][:200]) if "_edit_employee_data" in content else False:
        print("  ⏭️ تعديل 4: موجود مسبقاً")
    else:
        print("  ⚠️ تعديل 4: لم يتم العثور - سيتم الإضافة يدوياً")

# التعديل 5: إضافة الدوال الجديدة
new_functions = '''
...
if "_on_employee_saved" not in content:
    # نضيف قبل أول دالة show_ بعد _deactivate_employee
    # أو في نهاية قسم Employee Actions
    if "_deactivate_employee" in content:
        # نبحث عن الدالة اللي بعد _deactivate_employee
        parts = content.split("_deactivate_employee")
        if len(parts) >= 2:
            # نبحث عن أول def بعد _deactivate_employee
            rest = parts[1]
            next_def_pos = rest.find("\n    def ", 10)
            if next_def_pos > 0:
                insert_point = content.index("_deactivate_employee") + len("_deactivate_employee") + next_def_pos
                content = content[:insert_point] + new_functions + content[insert_point:]
                changes_made += 1
                print("  ✅ تعديل 5: إضافة الدوال الجديدة")
            else:
                content += new_functions
                changes_made += 1
                print("  ✅ تعديل 5: إضافة الدوال (في النهاية)")
    else:
        content += new_functions
        changes_made += 1
        print("  ✅ تعديل 5: إضافة الدوال (في النهاية)")
else:
    print("  ⏭️ تعديل 5: موجود مسبقاً")

# حفظ الملف
with open(MW_FILE, "w", encoding="utf-8") as f:
    f.write(content)

print(f"\n  📝 إجمالي التعديلات: {changes_made}")

# ══════════════════════════════════════════════════════════
# الخطوة 4: التحقق
# ══════════════════════════════════════════════════════════

print("\n[4/4] التحقق من الملفات...")

files_to_check = [
    os.path.join(EDIT_DIR, "__init__.py"),
    os.path.join(EDIT_DIR, "edit_employee_screen.py"),
    os.path.join(SCREENS_DIR, "__init__.py"),
    MW_FILE
]
...
for f in files_to_check:
    if os.path.exists(f):
        ...
        print(f"  ❌ {os.path.basename(f)} - غير موجود!")
        all_ok = False
...
if all_ok:
    ...
    print()
    print("   يمكنك حذف هذا الملف: install_edit_screen.py")
else:
